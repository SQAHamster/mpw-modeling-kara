 ...
 * <b>requires:</b> A front mushroom has to be movable<br/>
 * <b>requires:</b> Kara's front must not be blocked or outside world
 * 
 */
...
private:
	...
	bool helper_Precondition1_currentTile_result0_north_result1_north_result2_contents_is_empty() const noexcept;

	bool helper_Precondition1_currentTile_result0_west_result1_west_result2_contents_is_empty() const noexcept;

	bool helper_Precondition1_currentTile_result0_south_result1_south_result2_contents_is_empty() const noexcept;

	bool helper_Precondition1_currentTile_result0_east_result1_east_result2_contents_is_empty() const noexcept;
};

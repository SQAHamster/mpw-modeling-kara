...
void MoveCommand::execute() {
	...
	if (((self->mushroomFront()) ? (
			(self->getDirection() == mpw::Direction::WEST) ? (helper_Precondition1_currentTile_result0_west_result1_west_result2_contents_is_empty()) :
			true && (self->getDirection() == mpw::Direction::EAST) ? (helper_Precondition1_currentTile_result0_east_result1_east_result2_contents_is_empty()) :
			true && (self->getDirection() == mpw::Direction::NORTH) ? (helper_Precondition1_currentTile_result0_north_result1_north_result2_contents_is_empty()) :
			true && (self->getDirection() == mpw::Direction::SOUTH) ? (helper_Precondition1_currentTile_result0_south_result1_south_result2_contents_is_empty()) :
					true) :
			true) == false) {
...
bool MoveCommand::helper_Precondition1_currentTile_result0_north_result1_north_result2_contents_is_empty() const noexcept {
...
bool MoveCommand::helper_Precondition1_currentTile_result0_west_result1_west_result2_contents_is_empty() const noexcept {
	std::shared_ptr<const mpw::Tile> result0 = self->getCurrentTile();
	if (result0 == nullptr) {
		return false;
	}
...
bool MoveCommand::helper_Precondition1_currentTile_result0_south_result1_south_result2_contents_is_empty() const noexcept {
	std::shared_ptr<const mpw::Tile> result0 = self->getCurrentTile();
	if (result0 == nullptr) {
		return false;
	}
...
bool MoveCommand::helper_Precondition1_currentTile_result0_east_result1_east_result2_contents_is_empty() const noexcept {
	std::shared_ptr<const mpw::Tile> result0 = self->getCurrentTile();
	if (result0 == nullptr) {
		return false;
	}

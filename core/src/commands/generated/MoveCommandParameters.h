...
#ifndef DE_UNISTUTTGART_KARA_COMMANDSMOVEPARAMETERS_H
#define DE_UNISTUTTGART_KARA_COMMANDSMOVEPARAMETERS_H
...
struct MoveCommandParameters final {
	...
	MoveCommandParameters(std::shared_ptr<kara::ConcreteKara> self,
			commands::CommandStack &commandStack,
...
#endif //DE_UNISTUTTGART_KARA_COMMANDSMOVEPARAMETERS_H

#ifndef DE_UNISTUTTGART_ISTE_SQA_MPW_KARASIMULATOR_CPP_TESTUTILS_H
#define DE_UNISTUTTGART_ISTE_SQA_MPW_KARASIMULATOR_CPP_TESTUTILS_H
...
#endif //DE_UNISTUTTGART_ISTE_SQA_MPW_KARASIMULATOR_CPP_TESTUTILS_H

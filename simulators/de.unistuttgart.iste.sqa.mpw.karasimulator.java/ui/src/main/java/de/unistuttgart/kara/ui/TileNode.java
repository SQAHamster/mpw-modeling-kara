...
public class TileNode extends StackPane {
    ...
    private static void loadCornImages() {
        images.put("Tile", new Image("images/kachel.gif"));
        images.put("Tree", new Image("images/baumstumpf.gif"));
        images.put("Leaf", new Image("images/kleeblatt.gif"));
        images.put("Mushroom", new Image("images/pilz.gif"));
        images.put("Kara", new Image("images/marienkaefer.gif"));
    }
